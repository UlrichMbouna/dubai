...
const Patient = () => {
    ...
    return (
        ...
        <div className='d-flex'>
            ...
            <div className='d-flex' style={{marginBottom:'200px', alignItems: 'center', justifyContent: 'center', width: '30%', flexDirection: 'column' }}>
           <div>
                <img
                ...
                <h2 style={{ textAlign: 'center', color: '#5b5b5b',marginBottom:50 }}>Formulaire d'inscription</h2>
                <form onSubmit={handleSubmit} style={{ justifyContent: 'center', display: 'flex', flexDirection: 'column' }}>
                    ...
                    <div className="mb-3">
                        <label htmlFor="specialite" className="form-label">Email</label>
                        <input
                            type="text"
                            className="form-control"
                            id="Email"
